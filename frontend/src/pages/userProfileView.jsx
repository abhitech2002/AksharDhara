...
import { FaMapMarkerAlt, FaPhone, FaBirthdayCake, FaEnvelope, FaGithub, FaLinkedin, FaTwitter, FaGlobe, FaInstagram } from "react-icons/fa";
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="pt-20 px-8 pb-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{profile.data.displayName}</h1>
          ...
          <div className="mb-8 bg-gray-50 rounded-xl p-6">
            ...
            <p className="text-gray-700 leading-relaxed">{profile.data.bio || "No bio available"}</p>
          </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="flex items-center text-gray-700">
                  ...
                  {profile.data.dateOfBirth ? new Date(profile.data.dateOfBirth).toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric"
                  }) : "Not provided"}
                  ...
                  {profile.data.address ? (
                    <span>
                      {[profile.data.address.street,
                        ...
                        profile.data.address.zipCode].filter(Boolean).join(", ")}
                    </span>
                  ) : "Not provided"}
                </p>
              </div>
          ...
          {/* Social Links */}
          {profile.data.socialLinks && Object.keys(profile.data.socialLinks).length > 0 && (
              ...
              <div className="flex flex-wrap gap-4">
                {Object.entries(profile.data.socialLinks).map(([platform, url]) => (
                  url && (
                    ...
                    >
                      <span className="text-gray-600 mr-2">{socialIcons[platform]}</span>
